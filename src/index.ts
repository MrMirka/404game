...
import { findTargetPoint, getSafeDestination, isClickToObject, isPathClear } from './utils/gameMechanics'
...
document.addEventListener('click', (event) => {
    ...
    const intersectionCoordinate = getSafeDestination(banny.getPosition(), { x: event.clientX, y: event.clientY }, blackPixels, 15)
